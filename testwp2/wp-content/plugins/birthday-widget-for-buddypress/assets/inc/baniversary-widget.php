 ...
 */
class Widget_Buddypress_Aniversary extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			false,
			__( '(BuddyPress) Aniversaries', 'buddypress-birthdays' ),
			$widget_ops
		);
	}
	/**
 ...
 */
function buddypress_birthdays_register_widget_Aniversary() {
	register_widget( 'Widget_Buddypress_Aniversary' );
}
add_action( 'widgets_init', 'buddypress_birthdays_register_widget_Aniversary' );
